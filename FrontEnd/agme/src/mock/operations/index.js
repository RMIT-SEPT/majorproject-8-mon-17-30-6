const {getAllServicesProvider,authenticate, getAllServicesForUser, signupNewUser, getCompaniesFromAPI, getDecodedJwtFromLocalStorage} = require('./mock/functions/operations').default
module.exports = {
